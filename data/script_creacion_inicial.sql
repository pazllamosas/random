...
BEGIN 
	...
	INSERT INTO RANDOM.AFILIADO (IdPersona, IdEstadoCivil, CantidadACargo, IdPlan)
	VALUES((SELECT P.IdPersona FROM RANDOM.PERSONA P WHERE P.Documento = @DOCUMENTO), @IDESTADOCIVIL, @FAMILIARESACARGO, @IDPLAN)
END 
GO
